...
$sql= "INSERT INTO users (nameFirst, nameLast,password,username,EMAIL,age,gender,disorder,disability,illness,storyPrevious) VALUES('$firstname', '$lastname','$pass', '$username','$email','$age','$gender','$disorder','$disability','$illness','$previousStory')";
