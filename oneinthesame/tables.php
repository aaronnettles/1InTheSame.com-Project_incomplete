...
$tbl_usersone = "CREATE TABLE IF NOT EXISTS usersone (
...
$query = mysqli_query($doDB, $tbl_usersone);
if ($query === TRUE) {
...
$query = mysqli_query($doDB, $tbl_friends); 
if ($query === TRUE) {
...
$query = mysqli_query($doDB, $tbl_blockedusers); 
if ($query === TRUE) {
...
$query = mysqli_query($doDB, $tbl_status); 
if ($query === TRUE) {
...
$query = mysqli_query($doDB, $tbl_photos); 
if ($query === TRUE) {
...
$query = mysqli_query($doDB, $tbl_notifications); 
if ($query === TRUE) {
